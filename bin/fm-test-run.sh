...
family_for_basename() {
  case "$1" in
    ...
    fm-composer-ghost.test.sh|fm-composer-lib.test.sh|fm-context-reset-reminder.test.sh|\
    ...
    fm-episode-records-lib.test.sh|fm-extra-usage.test.sh|fm-help-flag.test.sh|fm-limit-resume.test.sh|\
    fm-spawn-project-memory.test.sh|\
    ...
    fm-launch-prompt-signals-live-e2e.test.sh|fm-extra-usage-live-e2e.test.sh|\
    ...
    fm-context-reset-reminder-live-e2e.test.sh|\
    ...
    fm-trace-context-spawn.test.sh|fm-spawn-worktree-settle.test.sh|fm-spawn-episode-records.test.sh|\
    fm-spawn-unfilled-brief.test.sh|\
    fm-spawn-compact-adviser-disable.test.sh|\
    fm-spawn-compact-adviser-disable-remote.test.sh|\
    fm-teardown-endpoint-safety.test.sh)
      printf '%s\n' backend-dispatch
      ;;
    fm-attribution-lib.test.sh|fm-check-unregister.test.sh|fm-pr-check-security.test.sh|fm-pr-merge.test.sh|\
    ...
    fm-adopted-process-lib.test.sh|\
...
portable_serial_weight_hints() {
  cat <<'EOF'
tests/fm-adopted-process-lib.test.sh 28117
...
tests/fm-episode-records-lib.test.sh 1221
...
tests/fm-spawn-episode-records.test.sh 6939
tests/fm-spawn-pool-base-freshen.test.sh 62249
tests/fm-spawn-project-memory.test.sh 8940
tests/fm-spawn-unfilled-brief.test.sh 9798
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-x-*|bin/fm-check*|bin/fm-attribution-lib.sh)
      printf '%s\n' pr-forge
      ;;
