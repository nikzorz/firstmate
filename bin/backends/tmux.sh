...
# for the composer-verification contract and echoed verdicts. The dispatcher's
# expected-label argument is unused here, and the harness that follows it scopes
# the core's busy check to that harness's verified footer signature.
