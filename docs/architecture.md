...
The residual that leaves is stated rather than hidden: the published park clock is truncated, and past a day of waiting it resolves to whole hours, so a decision written up to an hour before the current episode began still reads as written at it.
