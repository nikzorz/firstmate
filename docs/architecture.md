...
That escalation ends the episode and clears its absorb records, so a crew still stuck at the next stale episode repeats the cycle rather than carrying a permanent flag.
