...
FM_PAUSE_RESURFACE_SECS=3600       # seconds before an idle declared external wait, or a stale pane the watcher keeps absorbing on a still-advancing run step, re-surfaces for a recheck in the watcher or away-mode daemon
