...
The absorb is bounded: a pane held by it re-surfaces for a recheck once per `FM_PAUSE_RESURFACE_SECS` of true idle age, measured from the pane signature rather than the restarted timer.
