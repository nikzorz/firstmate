...
FM_SESSION_START_STATUS_NEWEST_BYTES=1000  # bytes kept from the newest status line before a visibly marked clip
FM_SESSION_START_STATUS_OLDER_BYTES=200    # bytes kept from each older status line in the same tail
