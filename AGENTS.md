...
state/               volatile runtime signals; gitignored
  ...
  <id>.pause-recheck   one-shot epoch at which a declared pause is rechecked ahead of its fixed cadence; bin/fm-classify-lib.sh owns it, removed by teardown
  <id>.park-sighting   last park episode this task was seen stopped at, with the crew's status content at that sighting; bin/fm-classify-lib.sh owns it, removed by teardown
