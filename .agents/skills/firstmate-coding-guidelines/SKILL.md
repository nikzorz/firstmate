...
- Never add an agent name as a commit co-author.
  ...
  Neither reaches codex, whose attribution is an account-side workspace setting that overrides repository rules, so do not add the trailer by hand on any harness.
